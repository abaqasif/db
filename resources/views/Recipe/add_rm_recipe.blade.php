...
<div>
                ...
                <table class="table table-condensed" style="width:90%">
                    <a href="{{url('/production/recipe/'.$rec->id.'/rm_list')}}" class="btn btn-info">Done Adding</a>

                    <h4>List of added Raw Materials:</h4>
                    <tr>
                        <th>SERIAL NO</th>
                        <th>TYPE</th>
                        <th>QUANTITY</th>
...
<table class="table table-condensed" style="width:90%">
    <h4>List of all available Raw Materials:</h4>
    <tr>
        <th>RM_CODE</th>
        <th>TYPE</th>
        <th>RATE</th>

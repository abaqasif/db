    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h3>Create Right</h3></div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/create_right') }}">
                        {{ csrf_field() }}
                           @if(count($errors)>0)
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Section</label>
                                    ...
                                    <!--  <option value="PURCHASE RECEIPTS">RAW MATERIALS</option>
                                    <option value="BILLS">SUPPLIERS</option> -->

                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/edit_user') }}">
                        ...
                        @endforeach
                          ...
                          @endif
                            ...
                            <div class="form-group{{ $errors->has('o_email') ? ' has-error' : '' }}">
                            <label for="o_email" class="col-md-4 control-label">Old Email Address</label>

                            <div class="col-md-6">
                                <input id="o_email" type="email" class="form-control" name="o_email" required>
